<nav class="flex flex-col bg-gray-900 w-64 max-h-full px-4 tex-gray-900 border border-purple-900">
    <div class="flex flex-wrap mt-8">
        <div class="w-1/2">
            <img src="{{ asset('img/'. Auth::user()->avatar->nom . '.png') }}" class="mx-auto w-20 h-20 rounded-full" />
        </div>
        <div class="w-1/2 mt-2 text-right">
            <span class="font-semibold text-white">{{ Auth::user()->name }} {{ Auth::user()->prenom }}</span>
